...
Each case below shows the input `_main.png` followed by every
phase picture (P1 → P2 → P3 → P4 → P5 → P7).
...
- `Origami_Gen_P7_6_compare/` — P7.6 quad-split fallback comparison
  (default vs. stress).
- `Origami_Gen_no_heightmap_verification/SUMMARY.md` — per-case
  gate counts + composite storyboards.
