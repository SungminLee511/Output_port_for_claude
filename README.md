...
## Full page
![full](./backtest_full_t20260702.png)

## Settings (live-only blocks dropped — only Identity / Universe / Sim-Costs)
![settings](./bt_settings_t20260702.png)

## Data Config
![dataconfig](./bt_dataConfig_t20260702.png)

## Custom Data (frozen — shown but disabled, with banner)
![customdata](./bt_customData_t20260702.png)

## Strategy Code
![code](./bt_strategyCode_t20260702.png)

## Run sub-tab (params + results + History; Run disabled until draft saved)
![run](./bt_run_t20260702.png)
